The game "Tic-Tac-toe", version 4.0.

Update history:

- 4.0:
    - game mode against an AI opponent added (AI makes its moves randomly)

- 3.0:
    - now you can choose the win combination length

- 2.0:
    - now you can choose the game field size
